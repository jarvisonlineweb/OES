...
SECRET_KEY = 'django-insecure-qar2oje*t@eb**p=46ms+85+wrti7bk3z2yvtau(zn)k(v=+n9'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'project/template'), os.path.join(BASE_DIR, 'client/template'),
                 os.path.join(BASE_DIR, 'expert/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
